...
{
    id: 1,
    titleFr: "Go paperless with your payslips",
    titleEn: "Go paperless with your payslips",
    descFr: "logiciel intranet.",
    descEn: "intranet software.",
    image: "/B.png",
 ...
 
  {
    ...
    descFr: "Site web pour présenter mes projets et compétences.",
    descEn: "Website to showcase my projects and skills.",
    image: "/portfolio.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
