...
{
    id: 1,
    titleFr: "Optez pour le numérique pour vos bulletins de paie",
    titleEn: "Go paperless with your payslips",
    descFr: "Plateforme intranet innovante permettant la dématérialisation sécurisée des bulletins de paie et la gestion RH centralisée.",
    descEn: "Innovative intranet platform for secure payslip digitization and centralized HR management.",
    image: "/B.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
    liveUrl: "https://frontend-fiche-paie.vercel.app/",
    githubUrl: "https://github.com/leoniegondo225/frontend-fiche-paie",
    enVedette: true,
  },
  {
    id: 2,
    ...
    descFr: "Solution e-commerce complète et un système de gestion sur mesure dédié aux instituts de beauté et salons de coiffure.",
    descEn: "Complete e-commerce solution and custom management system dedicated to beauty institutes and hair salons.",
    image: "/nappy.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
    liveUrl: "https://www.institutnappylocks.com/",
    githubUrl: "https://github.com/leoniegondo225/Frontend-nappylocks",
    enVedette: true,
  },

   {
    ...
    titleFr: "Elyva-tech",
    titleEn: "Elyva-tech",
    descFr: "Présentation numérique complète pour une entreprise de services techniques, mettant en avant leur expertise et solutions.",
    descEn: "Comprehensive digital presence for a technical services company, highlighting their expertise and solutions.",
    image: "/elyva.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
  ...
  },
  {
  ...
  },
   {
    ...
    descFr: "Plateforme de gestion d'assurance spécialisée pour les auditeurs, optimisant le suivi et la conformité des dossiers.",
    descEn: "Specialized insurance management platform for auditors, optimizing file tracking and compliance.",
    image: "/crystal.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
    liveUrl: "https://crystal03.vercel.app/",
    githubUrl: "https://github.com/ariel-industrie225/Crystal03",
    enVedette: true,
  },
  ...
  {
    id: 8,
    titleFr: "Les Pépites d'Ivoire",
    titleEn: "Les Pépites d'Ivoire",
    descFr: "Site vitrine raffiné pour une marque de textiles artisanaux de luxe, conçu pour sublimer l'art et la culture ivoirienne.",
    descEn: "Refined showcase website for a luxury artisanal textile brand, designed to sublimate Ivorian art and culture.",
    image: "/Site.png",
    technologies: ["Nextjs","JavaScript","firebase"],
    category: "Web Dev",
    liveUrl: "https://lespepitesdivoire.com/",
    githubUrl: "https://github.com/leoniegondo225/site-vitrine-art",
    enVedette: false,
  },
  {
    id: 9,
    ...
    descFr: "Expérience culinaire numérique avec menu interactif et intégration fluide des réseaux sociaux pour une visibilité accrue.",
    descEn: "Digital culinary experience with interactive menu and seamless social media integration for increased visibility.",
    image: "/pro5.png",
 ...
 
  {
    ...
    descFr: "Portfolio interactif présentant mon parcours, mes compétences techniques et mes réalisations en développement web.",
    descEn: "Interactive portfolio showcasing my background, technical skills, and web development achievements.",
    image: "/portfolio.png",
    technologies: ["Next.js", "Node.js", "Tailwind CSS"],
    category: "Full Stack",
    liveUrl: "https://elvis-adjegbe.vercel.app/",
    githubUrl: "https://github.com/leoniegondo225/elvisAdjegbe",
    enVedette: true,
  },
