export const translations = {
  fr: {
    ...
    about: {
      ...
      values: {
        adaptability: {
          title: "Adaptabilité",
          description:
            "Capacité d'adaptation et curiosité intellectuelle pour m'immerger rapidement dans de nouveaux environnements technologiques.",
        },
        passion: {
          title: "Passion",
          description:
            "Passionnée par le développement, je mets l'expérience utilisateur au cœur de toutes mes réalisations.",
        },
        rigor: {
          title: "Rigueur",
          description:
            "Reconnue pour ma rigueur et mon sens de l'organisation, des atouts essentiels pour mener à bien des projets complexes.",
        },
      },
    ...
    services: {
      title: "Mes Services",
      subtitle:
        "Je propose une gamme complète de services de développement Full-Stack et mobile, de la conception à la mise en production, en passant par la maintenance et l'optimisation.",
      ctaTitle: "Prêt à démarrer votre projet ?",
      ctaDescription:
        "Discutons de vos besoins et créons ensemble une solution sur mesure qui répond parfaitement à vos objectifs.",
      ctaButton: "Démarrer un projet",
    },
    projects: {
      title: "Mes Créations",
      subtitle:
        "Découvrez une sélection de mes projets récents, alliant créativité, performance technique et expérience utilisateur optimale.",
      ...
      ctaDescription:
        "Collaborons ensemble pour donner vie à vos idées et créer des solutions innovantes qui dépassent vos attentes.",
      ctaButton: "Discutons de votre projet",
    },
    contact: {
      title: "Contact",
      subtitle:
        "Vous avez un projet en tête ? N'hésitez pas à me contacter pour discuter de vos besoins et voir comment nous pouvons collaborer ensemble.",
  ...
  en: {
    ...
    about: {
      ...
      values: {
        adaptability: {
          title: "Adaptability",
          description:
            "Adaptability and intellectual curiosity to quickly immerse myself in new technological environments.",
        },
        passion: {
          title: "Passion",
          description: "Passionate about development, I put user experience at the heart of all my achievements.",
        },
        rigor: {
          title: "Rigor",
          description:
            "Recognized for my rigor and organizational skills, essential assets for successfully completing complex projects.",
        },
      },
    ...
    services: {
      title: "My Services",
      subtitle:
        "I offer a complete range of Full-Stack and mobile development services, from design to production, including maintenance and optimization.",
      ctaTitle: "Ready to start your project?",
      ctaDescription:
        "Let's discuss your needs and create together a custom solution that perfectly meets your objectives.",
      ctaButton: "Start a project",
    },
    projects: {
      title: "My Creations",
      subtitle:
        "Discover a selection of my recent projects, combining creativity, technical performance, and optimal user experience.",
      ...
      ctaDescription:
        "Let's collaborate to bring your ideas to life and create innovative solutions that exceed your expectations.",
      ctaButton: "Discuss your project",
    },
    contact: {
      title: "Contact",
      subtitle:
        "Have a project in mind? Feel free to contact me to discuss your needs and see how we can collaborate together.",
      location: "Location",
      email: "Email",
      phone: "Phone",
      form: {
